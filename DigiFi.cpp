...
String DigiFi::server(uint16_t port) {
  ...
  char* param1 = (char*)"TCP";
  char* param2 = (char*)"SERVER";
  char* ip = (char*)"127.0.0.1";
  setNetParams(param1, param2, port, ip);
...
void DigiFi::serverResponse(String response, int code) {
...
int DigiFi::connect(const char *host, uint16_t port = 80) {
    ...
    if(conn != host || isServer == "Server" || lastMode != digiFiMode) {
        if (digiFiMode == TCP) {
            char* param1 = (char*)"TCP";
            char* param2 = (char*)"CLIENT";
            setNetParams(param1, param2, port, host);
        } else {
            char* param1 = (char*)"UDP";
            char* param2 = (char*)"CLIENT";
            setNetParams(param1, param2, port, host);
        }
